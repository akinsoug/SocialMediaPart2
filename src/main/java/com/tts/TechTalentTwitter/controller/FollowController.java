...
public class FollowController {
    ...
    //We'll first create the follow method, which will be called whenever we make a post request to /follow/{username}.
    ...
    //Finally, we save userToFollow to flush our changes to the database and redirect to the last page
